...
if(!rs.next()) {
    out.println("<script>alert('Patient not found'); window.location='PatientLoginForm.jsp';</script>");
    return;
}
%>
...
<div class="navbar">
    ...
    <div class="navbar-actions">
        <a href="./AppointmentPage.jsp?id=<%= rs.getInt(1) %>" class="btn btn-primary">
            <i class="fas fa-calendar-plus"></i>
            Book Appointment
        </a>
        <a href="${pageContext.request.contextPath}/Controller/PatientLogOutProcess.jsp" class="btn btn-danger">
    ...
    <div class="dashboard-grid">
        ...
        <div class="profile-section">
            <div class="profile-header fade-in">
                ...
                <h2 class="patient-name"><%= rs.getString("name") %></h2>
            </div>
            
            <div class="profile-card fade-in delay-1">
                <div class="profile-avatar">
                    <%= rs.getString("name").charAt(0) %>
                </div>
                ...
                <div class="profile-details">
                    ...
                    <div class="detail-item">
                        ...
                        <div class="detail-content">
                            ...
                            <div class="detail-value"><%= rs.getInt("age") %> years</div>
                        </div>
                    </div>
                </div>
                ...
                <a href="./PatientEditForm.jsp?id=<%= rs.getInt(1)%>" class="edit-profile-link">
        ...
        <div class="appointments-section">
            ...
            ps= con.prepareStatement("select appointment.appt_id , doctor.name , doctor.specialization , appointment.appointment_date , appointment.appointment_time , appointment.status from appointment join doctor on appointment.did = doctor.did where appointment.pid = '"+id+"' order by  appointment.appointment_date desc");
            ...
            <div class="appointments-list">
                <div class="appointment-card fade-in delay-2">
                    <div class="card-header">
                        ...
                        <span class="appointment-badge">Upcoming</span>
                    </div>
